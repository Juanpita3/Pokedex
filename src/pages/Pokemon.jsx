  ...
  return (
    <main className='Pokemon'>
      <section className='pokemonId'>
        ...
        <section className='pokemonId__feactures'>
          <div className='pokemonId__feacture'>
            <p className='pokemonId__feacture-name'>Weight</p>
            <p className='pokemonId__feacture-value'>{dataPokemon?.weight}</p>
          </div>
          <div className='pokemonId__feacture'>
            <p className='pokemonId__feacture-name'>Height</p>
            <p className='pokemonId__feacture-value'>{dataPokemon?.height}</p>
          </div>
        </section>
